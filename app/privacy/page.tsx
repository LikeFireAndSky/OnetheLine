...
const page = () => {
	return (
		<div className="w-full h-full flex flex-col p-3 mt-3 space-y-5 overflow-scroll">
			<div>
				<h2 className="text-h2 font-bold">OneTheLine 개인정보처리방침</h2>
				OneTheLine은 개인정보보호법 제30조에 따라 정보주체의 개인정보를 보호하고
			...
			>
				...
				<div>
					...
					<br />
					<br />
					2. OneTheLine 서비스 회원가입을 위해 아이디(이메일), 비밀번호(이메일
					회원만 수집), 이름을을 수집하고 있으며 별도 서비스 이용 시 개인정보를
					수집할 경우 반드시 동의를 받고 개인정보를 수집하고 있습니다. <br />
					<br />
					3. OneTheLine 서비스 이용과정에서 서비스이용기록, 접속로그, IP주소
					등의 정보가 자동으로 생성되어 수집될 수 있습니다. <br />
					<br />
					4. OneTheLine 서비스에서 수집한 이용자 개인정보는 서비스 가입, 계약의
					이행 및 서비스 제공, 상담・불만・민원처리 등 서비스 제공을 위해 필요한
					...
					<table className="border border-border-sub w-[960px]">
						...
						<tbody>
							...
							<tr>
								...
								<td className="border border-border-sub p-5 align-top">
									디바이스 ID, , 서비스이용기록, IP주소, 접속로그, Cookie,
									광고식별자, 단말기 OS와 버전, 단말기 모델명, 브라우저 버전
								</td>
								<td className="border border-border-sub p-5 align-top">
									사업자/단체 홈페이지 탈퇴 시까지, 이용종료일 도래 시까지
								</td>
							</tr>
							<tr>
								<td className="border border-border-sub text-center p-5 align-top">
								...
								<td className="border border-border-sub p-5 align-top">
									[서비스 이용 시] 공통 - 이름, 이메일 주소
								</td>
								<td className="border border-border-sub p-5 align-top">
									이용종료일로부터 상담 등 민원처리를 위해 30일 후 삭제
									<br />
									관계법령에 따라 보존할 필요가 있는 경우 해당 법령에서 요구하는
									기한까지 보관 (예: 구매 회원의 경우 5년간, IP의 경우 3개월)
								</td>
			...
			<div
				...
				className="flex flex-col gap-3"
			>
				<h3 className="text-h3">4. 개인정보 보호책임자 및 권익침해 구제방법</h3>
				<div>
					...
					<br />
					<div className="pl-3">
						a. 개인정보 보호책임자: 김민섭(CPO) <br />
						<br />
						b. 개인정보 보호 담당부서: 개인정보팀(icdmiracle927@gmail.com){' '}
						<br />
						<br />
						c. OneTheLine 서비스 이용 시 발생하는 모든 개인정보보호 관련 문의와
						불만사항은 개인정보 보호책임자 또는 고객센터로 문의해주시면 됩니다.{' '}
						<br />
						<br />
						d. OneTheLine 고객센터: icdmiracle927@gmail.com <br />
						<br />
